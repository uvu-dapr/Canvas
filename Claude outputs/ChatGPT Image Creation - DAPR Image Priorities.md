# ChatGPT Image Creation: DAPR Image Priorities

ALL COURSES

Written 25 September 2026. This replaces the order of the big list. Work top down and stop whenever you like; everything below Tier 2 is optional.

Rule for every tier: a prompt is only here if the current file teaches something false or unreadable. Nothing marked Done in an older list is repeated here.

| Tier | What it is | Count | Needs ChatGPT |
|---|---|---|---|
| 1 | Wrong facts in core lessons, likely on a quiz | 19 | Yes |
| 2 | Wrong facts in secondary figures | 29 | Yes |
| 3 | Claude fixes in code, no ChatGPT usage | 5 | No |
| 4 | Needs a real photo or screenshot from you | 4 | No |
| 5 | Cosmetic only (clipped labels, banners, orientation art) | 24 plus 185 weak but correct | Skip for now |

# Tier 1. Make these first

## Tier 1, 01. DAPR 2000: Balanced_Audio.jpg

Wrong now: Cold leg drawn in the same polarity as hot, so the picture never shows why balanced lines cancel noise.
...
## Tier 1, 02. DAPR 2000: Send_vs_Insert.png

Wrong now: The reverb send dead ends; the effect never returns to the mix.
...
## Tier 1, 03. DAPR 2020: Send_versus_Insert_Routing.png

Wrong now: A dry track runs into the reverb instead of the mix buss.
...
## Tier 1, 04. DAPR 2000: Sampling_Quantization.png

Wrong now: Uneven sample spacing and inconsistent quantization levels, the exact things the page teaches.
...
## Tier 1, 05. DAPR 2000: Sine_Wave_with_Wavelength_and_Amplitude.png

Wrong now: Labels amplitude as power.
...
## Tier 1, 06. DAPR 2010: Air_to_File.png

Wrong now: Labels air and ears as the analog domain; they are acoustic.
...
## Tier 1, 07. DAPR 2010: Transducer_Types.png

Wrong now: Ribbon magnets drawn at the ends instead of along both sides of the ribbon.
...
## Tier 1, 08. DAPR 2255: Four_Band_Worked.png

Wrong now: Tells students to start reading from the tolerance band, which is backward.
...
## Tier 1, 09. DAPR 3255: Sine_Wave_With_Amplitude_Reference_Lines.png

Wrong now: RMS line drawn at 0.67 of peak instead of 0.707.
...
## Tier 1, 10. DAPR 3255: Breadboard_Internal_Connections.png

Wrong now: Both red rails on one edge and both blue on the other.
...
## Tier 1, 11. DAPR 3255: Body_Outlines_With_Current_Paths.png

Wrong now: Heart on the wrong side on an electrical safety figure.
...
## Tier 1, 12. DAPR 3255: Layer_Bars_With_Protocol_Pills.png

Wrong now: AES50 shown at Layer 2; it is Layer 1.
...
## Tier 1, 13. DAPR 3340: Dolby_Atmos_Speaker_Layout.png

Wrong now: Right rear speaker labeled Left Rear Surround; no LFE.
...
## Tier 1, 14. DAPR 3340: Cardioid_Array_With_Labeled_Distances.png

Wrong now: 17.5 cm labeled as 14 in (it is about 7 in).
...
## Tier 1, 15. DAPR 3340: Three_Cardioid_Front_Array_Diagram.png
...
## Tier 1, 16. DAPR 3340: IRT_Cross.png

Wrong now: IRT cross spacing labeled 1 to 2 ft; it is about 8 to 10 in.
...
## Tier 1, 17. DAPR 3340: Surround_Microphone_Array_With_Angles.png

Wrong now: Repeats the wrong 1 to 2 ft IRT spacing.
...
## Tier 1, 18. DAPR 3345: Bed_and_Objects_7_1_2.png

Wrong now: Labeled 7.1.2 but no LFE is drawn, so it shows 7.0.2.
...
## Tier 1, 19. DAPR 2020: First_Reflection_Points.png

Wrong now: Caption names four first reflection points; the drawing shows two.
...
# Tier 2. Wrong, but less central

## Tier 2, 01. DAPR 2000: Live_Sound_Roles.png

Wrong now: Split the path after the stage box: the front of house console drives the main PA to the audience, and a separate monitor mix feeds floor wedges aimed back at the performers. The original drew the wedge in series between the console and the audience.
...
## Tier 2, 02. DAPR 2000: Waveform_Basics.jpg

Wrong now: The legend's "Mode (Peak of Wave)" is wrong; the peak is the crest (compression). The new image has no legends, so use "crest" in the caption.
...
## Tier 2, 03. DAPR 2010: Drum_Kit_Panels_with_Overhead_Options.png

Wrong now: The snare now sits in front of the drummer, beside the kick, closest to the throne (known issue). Also, in the three mic panel the low side mic moves to the drummer's right, beside the floor tom, aimed across the kit at the snare; the current drawing puts it on the hi hat side.
...
## Tier 2, 04. DAPR 2010: Overhead_Kit_Plan_with_Red_Markers.png

Wrong now: Correct kit layout: throne at the bottom, snare nearest the throne, kick in front of the drummer with its front head facing away, and the kick out mic in front of that front head, on the far side from the drummer. The current drawing puts the kick where the throne should be and the kick out mic on the drummer's side.
...
## Tier 2, 06. DAPR 2010: Array_Panels_with_Drawn_Microphones.png

Wrong now: The spaced AB pair uses omnidirectional microphones, so its capsules are drawn as round omni heads pointing straight ahead. The image keeps three panels (spaced AB, ORTF, NOS); the caption and alt text say two spaced arrays, so either edit them to three or drop the NOS panel.
...
## Tier 2, 07. DAPR 2010: Room_Plan_with_Reflection_Points_Marked.png

Wrong now: Place each side wall reflection point by mirror geometry (angle in equals angle out), which puts it between the speaker and the listener along the wall, a little nearer the speaker; the current drawing places it too far back. Labels removed so nothing overlaps the paths.
...
## Tier 2, 09. DAPR 2020: Elastic_Audio_Warp_Markers.png

Wrong now: The current "after" row is a copy of the "before" row: the third hit sits off the grid in both. The new image shows one late hit before, the same hit on its grid line after, and the audio between markers visibly squeezed on one side and stretched on the other.
...
## Tier 2, 10. DAPR 2020: Scale_and_Target_Notes_Boxed.png

Wrong now: The keyboard must be a real keyboard: black keys shorter than white keys, in groups of two and three, with no black key between E and F or between B and C. The highlighted rows must be the notes of one real key (C major, the white key rows), not an arbitrary pattern.
...
## Tier 2, 13. DAPR 2255: AC_vs_DC_Traces.png

Wrong now: The AC direction cues now point one way on every positive half cycle and the opposite way on every negative half cycle, instead of both arrows pointing at one trough.
...
## Tier 2, 14. DAPR 2255: DMX_Universe_Addressing.png

Wrong now: The caption says two fixture ranges overlap but the current drawing shows three separate ranges; the new image shows the two wash fixture ranges visibly overlapping on shared channels, with the shared tiles marked in red.
...
## Tier 2, 16. DAPR 3255: Host_and_Cloud_Across_Translation_Box.png

Wrong now: On the outbound packet the source tag changes from private to public; on the returning packet the destination tag changes from public back to private. The current image labels the return traffic "from" both addresses, which is wrong.
...
## Tier 2, 17. DAPR 3255: Box_Chain_With_Return_Arc.png

Wrong now: The resolver does the walking. It asks the root, gets a referral back, asks the top level domain server, gets a referral back, asks the authoritative server, gets the answer back, and only then answers the client. The root does not forward to the next server, and the authoritative server does not answer the client directly.
...
## Tier 2, 18. DAPR 3255: Daisy_Chained_Boxes_and_No_Switch.png

Wrong now: Show the missing device as a network switch (a box with a row of ports), not a toggle switch.
...
## Tier 2, 19. DAPR 3340: Surround_Delivery_Formats.png

Wrong now: The 7.1 rows now show seven ear level speakers plus a subwoofer (the current dots show only five). Format names and channel counts go in the caption, top to bottom: Dolby Digital 5.1, DTS 5.1, Dolby TrueHD 7.1, DTS HD Master Audio 7.1, Dolby Atmos object based.
...
## Tier 2, 20. DAPR 3340: Surround_Session_Routing.png

Wrong now: Every source track now feeds exactly one submix bus (two dialogue tracks, two music tracks, two effects tracks), with track and cable colors matching their bus.
...
## Tier 2, 21. DAPR 3340: Loudness_Integrated_Shortterm_Truepeak.png

Wrong now: Integrated loudness is drawn as a level line at the program average, well above the floor, not on the zero line; the true peak marker gets its label; short term is shown as a moving curve with its sliding window.
...
## Tier 2, 22. DAPR 3340: Wide_Cardioid.png

Wrong now: Aim corrected to match the stated angles: L at 345 degrees and R at 15 degrees (15 degrees off straight ahead), rear pair at 195 and 165 degrees (15 degrees off straight back) and tilted 30 degrees upward. Distances go in the caption (C 20 cm, about 8 in, forward; L and R each 60 to 75 cm, about 23 to 30 in, from center; rear pair 150 to 200 cm, about 59 to 79 in, behind and 120 to 150 cm, about 47 to 59 in, apart).
...
## Tier 2, 23. DAPR 3340: Renderer_System_Topology.png

Wrong now: Timecode now flows from the workstation to the renderer (Pro Tools sends LTC and the renderer follows it), not from the renderer back to Pro Tools. Product names (Pro Tools, Dolby Atmos Renderer) go in the caption.
...
## Tier 2, 24. DAPR 2000: Post_Production_Roles.png

Wrong now: The dialogue edit stage now shows edited dialogue clips instead of a field recorder, which belongs to production sound.
...
## Tier 2, 25. DAPR 2000: Mastering_Chain.png

Wrong now: The limiter ceiling is true peak, minus 1.0 dBTP, as the caption says; the old in image label read dBFS. All settings stay in the caption.
...
## Tier 2, 26. DAPR 2020: Figure_8_Null_Plane.png

Wrong now: The lobes are drawn as teardrops; a figure of eight polar pattern is two equal round lobes touching at the capsule. The new image uses two equal spheres.
...
## Tier 2, 27. DAPR 3340: Location_Monitoring_Chain.png

Wrong now: The speaker branch now shows a compact 5.1 monitoring set instead of a stereo pair, since the chain monitors a surround recording. Stage order stays microphone array, preamps, A to D conversion, multitrack recorder, monitor controller, then headphones and speakers.
...
## Tier 2, 28. DAPR 3340: Bed_versus_Object_Decision.png

Wrong now: The object branch example "Dialogue" is replaced by a pass by vehicle, so both object examples actually move; dialogue belongs with the fixed bed material in the page text.
...
## Tier 2, 29. DAPR 3340: Mastering_Signal_Chain.png

Wrong now: An EQ stage is added after the mix so the image matches the alt text (equalization, compression, limiting, dither), and the unexplained gradient bar is removed. Order: mix, EQ, multiband compression, mid side, limiting, dither, master.
...
# Tier 3. Claude fixes these in code, no ChatGPT

Exact charts, so Standards 0 choice 2 applies. Say go and they are done in one pass.

| Course | File | Fix |
|---|---|---|
| DAPR 2000 | Equal_Loudness.png | Redraw from ISO 226 data: the 3 to 4 kHz dip and flatter curves at higher phon. |
| DAPR 2000 | Bit_Depth_Ladder.png | Broken axis and a label for 32 bit float (about 1,500 dB theoretical). |
| DAPR 2255 | Orders_of_Magnitude.png | Bars that actually step by ten times, on a log scale. |
| DAPR 2010 | Proximity_Effect.png | Label each curve at its left end; add dB to the axis. |
| DAPR 2010 | Decibel_Scales_Aligned_at_Nominal.png and Meter_Alignment_Scales.png | Both redrawn to one alignment once you say which one Studio B uses. |

# Tier 4. Needs a real photo or screenshot

| Course | File | What is wrong |
|---|---|---|
| DAPR 2000 | MIDI_5_Pin_DIN_Pin_Layout.png | Pins drawn in a ring; a real 180 degree DIN has five pins on one arc, 1, 4, 2, 5, 3, with pin 2 opposite the key. |
| DAPR 2000 | Firewire_400_4_Pin.png | Shows the 6 pin plug body. |
| DAPR 3340 | Send_Assignment_Context_Menu_On_Strip.jpg | Shows the VCA menu, not the send menu. |
| DAPR 2020 | Technical_Ear_Trainer_Settings.png | A Word window covers the controls. |

# Tier 5. Skip for now

These are correct, just plain: banners, orientation and admin art, clipped labels, and the 185 weak but correct diagrams. Several would come back looking like images you already have, which is the waste you just hit. They stay in the big file if you ever want them:

```
/Users/adamwolson/Library/CloudStorage/Dropbox/apps/GitHub/Canvas/Classes/_briefs/ChatGPT Image Creation - DAPR All Courses Line Drawing Replacements.md
```

Tier 5 items from the wrong list, all cosmetic or wording: ALL COURSES Room_Layout.png, ALL COURSES SI_Prefix_Ladder.png, DAPR 2000 Game_Audio_Pipeline.png, DAPR 2000 Module_Banner.png, DAPR 2000 Module_Banner.png, DAPR 2000 Module_Banner.png, DAPR 2000 Mix_Arc.png, DAPR 2000 Home_Studio_Signal_Flow.jpg, DAPR 2010 Wiki_Banner.png, DAPR 2010 Punch_and_Playlists.png, DAPR 2010 Wiki_Banner.png, DAPR 2020 Three_Source_Depth_Map.png, DAPR 2020 Grade_Breakdown.png, DAPR 2020 Weekly_Rhythm.png, DAPR 2020 App_Leftover_Files.png, DAPR 2020 DMG_PKG_EXE_Flow.png, DAPR 2255 Cathode_Band_and_Symbol.png, DAPR 2255 Show_Control_Hub.png, DAPR 2255 Breadboard.png, DAPR 3345 Credit_Hour_Rule.png, DAPR 3255 Doped_Blocks_and_Depletion_Gap.png, DAPR 3255 One_Switch_and_Dashed_Divider.png, DAPR 3255 Broadcast_Question_and_Single_Reply.png, DAPR 3340 Post_Production_Mix_Workflow_Chart.jpg.
